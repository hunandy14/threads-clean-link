...
| D5 | Google client 沿用手機的 Web client（ID 為公開值：`17054024593-p003rp6cqmm9ks4r8mdphal1ahr3rhum.apps.googleusercontent.com`），Console 已加 redirect URI `https://hehokicokbgajpanjcajhmflaennnmdj.chromiumapp.org/` | 後端 `aud` 陣列已含此 client，不需第四組 ID | 2026-09-02 |
